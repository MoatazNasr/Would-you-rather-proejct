...
export default function Answered(props) {
    ...
    let opt1perc = optionOneVotes.length ===3  ? 100:  optionOneVotes.length *33.3  
    let opt2perc = optionTwoVotes.length ===3  ? 100:  optionTwoVotes.length *33.3  
                    ...
                    <div>
                        <CardContent>
                            ...
                            <div id='div-1' className='option-group'>
                                ...
                                <div className='progressbar' style={{ height: 20, marginBlock:10 ,width: `${opt1perc}%` }} >{opt1perc}%  </div>
                            ...
                            <div id='div-2' className='option-group'>
                                ...
                                <div className='progressbar' style={{ height: 20, marginBlock:10,width: `${opt2perc}%`}}>{opt2perc}% </div>
